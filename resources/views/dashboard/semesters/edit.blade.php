...
<div class="row">
	...
	<div class="col-md-6">
		<div class="portlet-body form">
					...
					<form role="form" method="post" action="{{route('subjects.update', ['id' => $subject->id])}}" style="padding-top:10px;">
						...
						<div class="form-body">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input type="text" name="code" value="{{$subject->code or old('code')}}" class="form-control" placeholder="Subject Code">
							...
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input type="text" name="name" value="{{$subject->name or old('name')}}" class="form-control" placeholder="Subject Name">
