...
@section('content')
    ...
    <div class="page-content-wrapper" id="content">
        <div class="page-content">
            ...
            <div class="page-bar">
                {!! Breadcrumbs::render('batches.index') !!}
            </div>
            <!-- END PAGE HEADER-->
            <!-- BEGIN PAGE CONTENT-->
            <div class="row">
                        ...
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <a href="{{route('batches.create')}}" class="btn green">
                                ...
                                @foreach($batches as $batch)
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            ...
                                            {{\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $batch->start_at)->formatLocalized('%d %B %Y')}}
                                        </td>
                                        <td>
                                            {{\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $batch->end_at)->formatLocalized('%d %B %Y')}}
                                        </td>
                                        <td>
                                            {{statusTable($batch->status)}}
                                        </td>
                                        <td align="center">
                                            <a class="btn green"
                                            ...
                                            <a class="btn red"
                                               onclick="deleteBatch('{{$batch->id}}',' {{$batch->name}}')"><i
